...
namespace SBSBC\Install;

use SBSBC\Data\OrderSource;
...
class Schema {
	 ...
	 */
	const VERSION_OPTION = 'sbsbc_db_version';
	...
	public static function table() {
		...
		return $wpdb->prefix . 'sbsbc_order_state';
	}
	...
	public static function table_exists() {
		...
		return (bool) $wpdb->get_var(
			$wpdb->prepare( 'SHOW TABLES LIKE %s', $wpdb->prefix . 'sbsbc_order_state' )
		);
	}
	...
	public static function row_count() {
		...
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
		return (int) $wpdb->get_var( "SELECT COUNT(*) FROM {$wpdb->prefix}sbsbc_order_state" );
	}

	/**
	 * Row count alongside the number of orders on the BigCommerce account.
	 *
	...
	public static function truncate() {
		...
		$wpdb->query( "TRUNCATE TABLE {$wpdb->prefix}sbsbc_order_state" );
	}
}
